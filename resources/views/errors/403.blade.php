...
<head>
  ...
  <title>403 – Akses Ditolak | Inventaris Bengkel</title>
  ...
  <style>
    ...
    .error-code { font-size:7rem; font-weight:800; line-height:1;
      background:linear-gradient(135deg,#ef4444,#7c3aed); -webkit-background-clip:text;
...
<div class="error-wrap">
  ...
  <p class="error-desc">
    ...
    Halaman ini hanya dapat diakses oleh pengguna dengan hak tertentu.
  </p>
